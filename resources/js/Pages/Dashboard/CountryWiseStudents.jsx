...
import CountryWiseStudentsChart from './TabsComponents/Charts/CountryWiseStudentsChart'

const { Option } = Select;
const CountryWiseStudents = () => {
            ...
            <Layout currentPage={0}>
                <div className="dashboard-wrapper">
                    <div className="d-flex justify-content-start align-items-center">
                        <InertiaLink href={"/dashboard"} data={{tab: "students"}} preserveState >
...
export default CountryWiseStudents
